...
const AppDetails = () => {
    ...
    return (
      <div className="flex justify-center items-center min-h-screen">
        <p className="text-2xl text-gray-500 font-semibold">Loading app details...</p>
      </div>
    );
  }
    ...
    return (
       <div>
        ...
        <div>
            ...
            <p className='text-[#627382] text-xl font-semibold mt-2 mb-6'>Developed by <span className='text-transparent bg-clip-text bg-[linear-gradient(125.07deg,_#632EE3,_#9F62F2)] '>{companyName}</span></p>
        </div>
