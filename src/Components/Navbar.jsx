    ...
    <div className="navbar bg-base-100 shadow-sm">
      <div className="navbar-start">
        ...
        <NavLink to="/" className="w-10 h-10 cursor-pointer flex items-center">
          ...
          <span className="text-transparent bg-clip-text bg-[linear-gradient(125.07deg,_#632EE3,_#9F62F2)] font-bold text-[16px]">
            HERO.IO
          </span>
        </NavLink>
      </div>
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 text-[#000000e6] font-semibold text-[16px] [&_li>a:hover]:!bg-transparent">
          ...
          <li>
            <NavLink to="/apps" className={activeNavLink}>
              Apps
            </NavLink>
          </li>
          <li>
            <NavLink to="/installation" className={activeNavLink}>
              Installation
            </NavLink>
          </li>
        </ul>
      ...
      <div className="navbar-end">
        <NavLink
          to="https://github.com/marufaakter1947"
          target="_blank"
          className="btn  bg-[linear-gradient(125.07deg,_#632EE3,_#9F62F2)] text-white text-[16px] font-semibold"
        >
          {" "}
          <FaGithub /> Contribute
        </NavLink>
